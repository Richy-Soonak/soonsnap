    ...
    <footer className="border-t border-border bg-[#0a0a14] px-5 pt-16 pb-8">
      <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-sm text-[#999]">
            <li><a href="#" className="hover:text-gold transition-colors">Richy Soonak</a></li>
            <li><a href="#" className="hover:text-gold transition-colors">Buy $SOONAK</a></li>
            <li><a href="#" className="hover:text-gold transition-colors">Telegram</a></li>
            <li><a href="#" className="hover:text-gold transition-colors">Roadmap</a></li>
          </ul>
        </div>
      ...
      <div className="mx-auto mt-14 flex max-w-7xl flex-col items-center justify-between gap-4 border-t border-border pt-6 md:flex-row">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* GitHub */}
          <a href="#" aria-label="GitHub" className="text-[#555] hover:text-gold transition-colors">
            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
